...
const FLIGHT_SECONDS := GameData.ARROW_FLIGHT_SECONDS
const ARC_HEIGHT := GameData.ARROW_ARC_HEIGHT
const LANDED_VISIBLE_SECONDS := GameData.ARROW_LANDED_VISIBLE_SECONDS
const FADE_SECONDS := GameData.ARROW_FADE_SECONDS
